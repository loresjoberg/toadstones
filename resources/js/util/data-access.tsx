...
export function formatFeature(rawFeature: RawFeature, sections: Section[]): Feature {
    const section: Section | undefined = _.find(sections, ["id", rawFeature.section_id])
...
export const formatFeatures = (rawFeatures: RawFeature[], sections: Section[]): Feature[] => {
...
export const fetchRawFeatures = async () => {
    return await axios.get(config.apiFeatures)
        .then((response) => {
...
export const fetchSections = async () => {
    return await axios.get(config.apiSections)
        .then((response) => {
            // console.log(response.data);
            return response.data
        })
